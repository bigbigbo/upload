...
import idCardFront from '../../assets/icons/clsc_img_sfzgrxxm.png';
import idCardBack from '../../assets/icons/clsc_img_sfzghm.png';
...
import styles from '../styles/IDCard.module.less';

import { UPLOADING, UPLOAD_SUCCESS } from '../../constants/uploadStatus';
import { ID_CARD_FRONT } from '../../constants/fileType';

const IDCard = (props) => {
  const { type = ID_CARD_FRONT, file = {}, uploadOptions = {}, onUpload, onSelect, onPreview, onDelete, onAbort, onJoinLib } = props;
  ...
  const isFrontend = type === ID_CARD_FRONT;
  const displayInfo = {
    thumb: isFrontend ? idCardFront : idCardBack,
    text: isFrontend ? '身份证个人信息面' : '身份证国徽面'
  };
